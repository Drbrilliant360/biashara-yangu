...
const EditProductPage: React.FC = () => {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      sellingPrice: '', buyingPrice: '', stockQuantity: '',
      minStockLevel: '', category: '', unit: '',
    },
  });
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      form.reset({
        ...
        buyingPrice: String(data.buying_price),
        stockQuantity: String(data.stock_quantity),
        minStockLevel: String(data.min_stock_level),
  ...
  if (loading) {
    return <div className="flex items-center justify-center h-[60vh] text-muted-foreground">Loading product...</div>;
  }
